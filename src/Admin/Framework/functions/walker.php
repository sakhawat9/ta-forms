 ...
 *
 */
if ( ! class_exists( 'Chat_Help_Pro_Walker_Nav_Menu_Edit' ) && class_exists( 'Walker_Nav_Menu_Edit' ) ) {
  class Chat_Help_Pro_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {

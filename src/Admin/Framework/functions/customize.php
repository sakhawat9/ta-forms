...
if ( ! class_exists( 'WP_Customize_Panel_TaForms' ) && class_exists( 'WP_Customize_Panel' ) ) {
  class WP_Customize_Panel_TaForms extends WP_Customize_Panel {
    public $type = 'ta-forms';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Section_TaForms' ) && class_exists( 'WP_Customize_Section' ) ) {
  class WP_Customize_Section_TaForms extends WP_Customize_Section {
    public $type = 'ta-forms';
  }
}
 ...
 *
 */
if ( ! class_exists( 'WP_Customize_Control_TaForms' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_TaForms extends WP_Customize_Control {
    ...
    public function render() {
      ...
      if ( ! empty( $this->field['dependency'] ) ) {
        ...
        $visible  = ' ta-forms-dependency-control';
    ...
    public function render_field_content() {
      ...
      $class      = ( $is_complex || $custom ) ? ' ta-forms-customize-complex' : '';
      ...
      echo '<div class="ta-forms-customize-field'. esc_attr( $class ) .'"'. $atts .'>';

      TaForms::field( $this->field, $this->value(), $this->unique, 'customize' );

...
(function($) {
  ...
  function TaFormsAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  TaFormsAjaxChosen.prototype.init = function() {
  ...
  TaFormsAjaxChosen.prototype.events = function() {
  ...
  TaFormsAjaxChosen.prototype.search_field_focused = function() {
  ...
  TaFormsAjaxChosen.prototype.search_welcome_message = function() {
  ...
  TaFormsAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('ta-forms-chosen', _this.options.data).done( function( response ) {
  ...
  TaFormsAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.ta-forms-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.TaFormsChosenOrder($hidden_value, true);
  ...
  $.fn.TaFormsAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new TaFormsAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, TaFormsAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  TaFormsAbstractChosenOrder = (function() {

    function TaFormsAbstractChosenOrder() {}

    TaFormsAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    TaFormsAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    TaFormsAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    TaFormsAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    TaFormsAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    TaFormsAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    TaFormsAbstractChosenOrder.TaFormsChosenOrder = function(select, order, force) {
    ...
    return TaFormsAbstractChosenOrder;
  ...
  $.fn.extend({
    TaFormsChosenOrder: function(order, force) {
      return _TaFormsChosenOrder.TaFormsChosenOrder(this, order, force);
    }
  });

  this._TaFormsChosenOrder = (function(_super) {
    __extends(_TaFormsChosenOrder, _super);

    function _TaFormsChosenOrder() {
      _ref = _TaFormsChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _TaFormsChosenOrder.relAttributeName = 'data-option-array-index';

    _TaFormsChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _TaFormsChosenOrder.getDOMElement = function(element) {
    ...
    _TaFormsChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _TaFormsChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _TaFormsChosenOrder;

  })(TaFormsAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('ta-forms-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('ta-forms-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectTaForms = FormSerializer.serializeObject;
    $.fn.serializeJSONTaForms   = FormSerializer.serializeJSON;
  }

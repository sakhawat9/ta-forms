...
if ( ! class_exists( 'Chat_Help_Pro_Field_textarea' ) ) {
  class Chat_Help_Pro_Field_textarea extends Chat_Help_Pro_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( TaForms::$shortcode_instances ) ) ? TaForms::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary ta-forms-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';

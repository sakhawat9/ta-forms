...
if ( ! class_exists( 'Chat_Help_Pro_Field_sortable' ) ) {
  class Chat_Help_Pro_Field_sortable extends Chat_Help_Pro_Fields {
    ...
    public function render() {
      ...
      echo '<div class="ta-forms-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="ta-forms-sortable-item">';

          echo '<div class="ta-forms-sortable-content">';
          ...
          TaForms::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="ta-forms-sortable-helper"><i class="icofont-drag"></i></div>';

 ...
 *
 */
if ( ! class_exists( 'Chat_Help_Pro_Field_link_color' ) ) {
  class Chat_Help_Pro_Field_link_color extends Chat_Help_Pro_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'ta-forms' ),
        'hover'    => esc_html__( 'Hover', 'ta-forms' ),
        'active'   => esc_html__( 'Active', 'ta-forms' ),
        'visited'  => esc_html__( 'Visited', 'ta-forms' ),
        'focus'    => esc_html__( 'Focus', 'ta-forms' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if ( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="ta-forms--left ta-forms-field-color">';
          echo '<div class="ta-forms--title">'. esc_attr( $color_prop_value ) .'</div>';
          echo '<input type="text" name="'. esc_attr( $this->field_name( '['. $color_prop_key .']' ) ) .'" value="'. esc_attr( $value[$color_prop_key] ) .'" class="ta-forms-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';

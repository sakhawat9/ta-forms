 ...
 *
 */
if ( ! class_exists( 'Chat_Help_Pro_Field_color' ) ) {
  class Chat_Help_Pro_Field_color extends Chat_Help_Pro_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="ta-forms-color"'. $default_attr . $this->field_attributes() .'/>';

...
if ( ! class_exists( 'Ta_Forms_Fields' ) ) {
  abstract class Ta_Forms_Fields extends Ta_Forms_Abstract {
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="ta-forms-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="ta-forms-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="ta-forms-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="ta-forms-help"><span class="ta-forms-help-text">'. $this->field['help'] .'</span><i class="icofont-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="ta-forms-error-text">'. $this->field['_error'] .'</div>' : '';

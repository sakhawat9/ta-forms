            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'dependency' => array('ta_forms_redirect', '==', 'same_page'),
                    ),
                    array(
                    ...
                    array(
                        'id'         => 'ta_forms_redirect_to_page',
                        'type'       => 'select',
                        'title'      => __('Page', 'ta-forms'),
                        'subtitle'   => __('Select redirect page.', 'ta-forms'),
                        'options'    => 'pages',
                        'dependency' => array('ta_forms_redirect', '==', 'to_a_page'),
                    ),
                    array(
                        'id'         => 'ta_forms_redirect_custom_url',
                        'type'       => 'text',
                        'title'      => __('Custom URL', 'ta-forms'),
                        'subtitle'   => __('Type redirect custom url.', 'ta-forms'),
                        'dependency' => array('ta_forms_redirect', '==', 'custom_url'),
                    ),
                ),
            )
        );

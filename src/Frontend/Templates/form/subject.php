...
<div class="form_field">
    ...
    <?php } ?>
    <input title="<?php echo esc_attr($custom_validation_message) ?>" type="text" id="ta_forms_subject" subject="ta_forms_subject" <?php echo esc_html($required); ?> placeholder="<?php echo esc_html($placeholder); ?>" />
</div>
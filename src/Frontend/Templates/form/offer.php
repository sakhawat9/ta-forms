...
<div class="form_field">
    ...
    <?php } ?>
    <input title="<?php echo esc_attr($custom_validation_message) ?>" type="number" id="ta_forms_offer" name="ta_forms_offer" value="39" <?php echo esc_html($required); ?> placeholder="<?php echo esc_html($placeholder); ?>" />
</div>